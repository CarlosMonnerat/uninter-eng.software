...
# Verifica se o sabor digitado é válido ou não:
    if(sabor == 'tr'):     # Caso o usuário digitar "tr" o código executará as instruções abaixo:
        bolas = input('Entre com o número de bolas de sorvete desejado (1/2/3): ')
        if(bolas == '1'):                           # Verifica se o número de bolas de sorvete digitado é válido ou não
            valor += 6
        ...
        else:                                       # Caso o nº de bolas de sorvete for inválido, irá printar a msg a baixo:
            print('Número de bolas de sorvete inválido. Tente novamente')
            continue                                # O programa voltará para o início do looping.

    elif(sabor == 'pr'):   # Caso o usuário digitar "pr" o código executará as instruções abaixo:
        bolas = input('Entre com o número de bolas de sorvete desejado (1/2/3): ')
        if (bolas == '1'):
            valor += 7
    ...
    elif (sabor == 'es'):  # Caso o usuário digitar "es" o código executará as instruções abaixo:
        bolas = input('Entre com o número de bolas de sorvete desejado (1/2/3): ')
        if (bolas == '1'):
            valor += 8
