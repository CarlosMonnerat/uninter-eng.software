'''
Exercício 01: Escreva as seguintes expressões booleanas em linguagem Python:
...
#c)
3**2 + 4**2 == 25               #Saída: True

#d)
2 + 4 + 6 > 12                  #Saída: False

#e)
1387 % 19 == 0                  #Saída: True

#f)
31 % 2 == 0                     #Saída: False

#g)
min(34, 29, 31) < 30    #Saída: True